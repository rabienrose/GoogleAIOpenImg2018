  ...
  Returns:
    ...
    OpenImagesDetectionChallengeEvaluator.add_single_ground_truth_image_info:
        ...
        standard_fields.InputDataFields.groundtruth_group_of: Optional length
          ...
          group of instances.
  """
  #print(data.LabelName.isin(class_label_map))
  filtered_data_frame = data[data.LabelName.isin(class_label_map)]
  data_boxes = filtered_data_frame[filtered_data_frame.ConfidenceImageLabel.isnull()]
  data_labels = filtered_data_frame[filtered_data_frame.XMin.isnull()]
...
def build_predictions_dictionary(data, class_label_map):
  ...
  """
  data = data[data.LabelName.isin(class_label_map)]
  return {
